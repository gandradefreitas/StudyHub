...
def adicionar_tarefas_controller(usuario_id):
    ...
    print(
        "[green]Tarefa adicionada com sucesso![/]"
    )
...
def editar_tarefa_controller(usuario_id):
    ...
    print(
        "[green]Tarefa editada com sucesso![/]"
    )
...
def concluir_tarefa_controller(usuario_id):
    ...
    if concluir_tarefa(
        ...
        print(
            "[green]Status da tarefa atualizado![/]"
        )

    else:

        print(
            "[red]Tarefa não encontrada.[/]"
        )
...
def excluir_tarefa_controller(usuario_id):
    ...
    print(
        "[green]Tarefa excluída com sucesso![/]"
    )
